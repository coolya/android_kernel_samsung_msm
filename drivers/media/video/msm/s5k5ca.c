...
void cam_pw(int status)
{
	...
	{
	    PCAM_DEBUG("POWER ON");
		printk("<=PCAM=> tass cam_pw test~~~~~~~~~~~~~~~~~~~~~~~\n");
	    vreg_set_level(vreg_cam_out10, OUT1200mV);//1800
	    vreg_set_level(vreg_cam_out9,  OUT2800mV);//2800
	    vreg_set_level(vreg_cam_out8,  OUT2800mV);//2600
