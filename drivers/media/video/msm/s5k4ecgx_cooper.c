...
int s5k4ecgx_set_af(char value)
{
	...
	switch(value)
	{
		...
		case PCAM_AF_POWEROFF :
			...
			if(s5k4ecgx_status.scene != PCAM_SCENE_NIGHTSHOT)S5K4ECGX_WRITE_LIST(s5k4ecgx_AF_Normal_mode_4);
		break;		
		default :
...
void s5k4ecgx_set_capture(void)
{
	...
	{
#if defined(CONFIG_SAMSUNG_LTN_COMMON)	//latin_cam:jyc for system lag
