...
static int16_t s5k4ecgx_wb = PCAM_WB_AUTO;
static int16_t s5k4ecgx_iso = PCAM_ISO_AUTO;
...
void s5k4ecgx_set_whitebalance(char value)
{
	...
	else
	{
		...
		{
			case PCAM_WB_AUTO :
				S5K4ECGX_WRITE_LIST(s5k4ecgx_WB_Auto_ISO_on);
				s5k4ecgx_wb = PCAM_WB_AUTO;				
			break;
			case PCAM_WB_DAYLIGHT :
				S5K4ECGX_WRITE_LIST(s5k4ecgx_WB_Sunny_ISO_on);
				s5k4ecgx_wb = PCAM_WB_DAYLIGHT;				
			break;
			case PCAM_WB_CLOUDY :
				S5K4ECGX_WRITE_LIST(s5k4ecgx_WB_Cloudy_ISO_on);
				s5k4ecgx_wb = PCAM_WB_CLOUDY;				
			break;
			case PCAM_WB_FLUORESCENT :
				S5K4ECGX_WRITE_LIST(s5k4ecgx_WB_Fluorescent_ISO_on);
				s5k4ecgx_wb = PCAM_WB_FLUORESCENT;				
			break;
			case PCAM_WB_INCANDESCENT :
				S5K4ECGX_WRITE_LIST(s5k4ecgx_WB_Tungsten_ISO_on);
				s5k4ecgx_wb = PCAM_WB_INCANDESCENT;				
			break;
			default :
				printk("[S5K4ECGX]Unexpected WB mode : %d\n",  value);
