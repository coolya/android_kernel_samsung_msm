...
static struct usb_mass_storage_platform_data mass_storage_pdata = {
	.nluns		= 1,
	.vendor		= "SAMSUNG ",
//[LTN_SYSTEM] Dh77.Ji:Changed the name of USB mass storage for BENI: 2010.12.21
#ifdef CONFIG_SAMSUNG_BENI_LTN_L
	.product	= "GT-S5670L Card",
#elif  CONFIG_SAMSUNG_BENI_LTN_B
	.product	= "GT-S5670B Card",
#else 
...
//for sleep current		GPIO_CFG(0,  0, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_8MA), /* nCAM_3M_RST */
...
static uint32_t camera_on_gpio_table[] = {
	/* parallel CAMERA interfaces */
//for sleep current		GPIO_CFG(0,  0, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_8MA), /* nCAM_3M_RST */
