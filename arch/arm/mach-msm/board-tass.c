...
//[LTN_SYSTEM] Dh77.Ji:Changed the name of USB mass storage for TASS: 2010.12.21
#ifdef CONFIG_SAMSUNG_TASS_LTN_L
	.product	= "GT-S5570L Card",
#elif  CONFIG_SAMSUNG_TASS_LTN_B
